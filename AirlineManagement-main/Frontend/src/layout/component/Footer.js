                ...
                <footer className="page-footer font-small unique-color-dark mt-0 pt-0">
                    <div style={footStyle} className='bg-dark'>
                        <div className="card-deck py-4 mx-4 px-2 ">
                            <div className="card">
                                ...
                                src='https://chaloghumane.com/wp-content/uploads/2021/02/goa.jpg' height='150px'
                                />
                            ...
                            <div className="card">
                                <img className="card-img"
                                 src="https://i0.wp.com/onedayitinerary.com/wp-content/uploads/2020/02/One-day-in-Manali-Itinerary-India.jpg" height='150px'
                                />
                                <div className="card-body">
                            ...
                            <div className="card">
                                <img className="card-img"
                                src="https://www.holidaymonk.com/wp-content/uploads/2022/04/Best-of-North-East-India-Tour-Packages.jpg" height='150px'
                                />
                                <div className="card-body">
                            ...
                            <div className="card">
                                <img className="card-img"
                                src="https://www.hranker.com/blog/wp-content/uploads/2021/02/Rajasthan-GK-Notes.jpeg" height='150px'
                                />
                                <div className="card-body">
                    ...
                    <div style={footerStyle}>        
                        ...
                        <div className="form-inline footer-copyright" style={footerStyle1}>
                            <h6 className="mx-4 my-0 pt-2 pb-0 px-3">©Copyright 2022 <i class="fas fa-paper-plane mr-1"></i>GSK Airlines</h6>
