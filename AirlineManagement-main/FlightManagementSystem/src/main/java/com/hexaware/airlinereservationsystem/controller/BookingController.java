...
import com.hexaware.airlinereservationsystem.dao.BookingServiceImpl;
import com.hexaware.airlinereservationsystem.dao.PassengerServiceImpl;
...
public class BookingController {
    ...
    public ResponseEntity<String> updatePassenger(@PathVariable(name="bookingId") int bookingId,@RequestBody Passenger p){
    	...
    	return response;
    	 ...
    	 @GetMapping("/getBooking/{bdate}")
    		List<Booking> getBookingByDate(
    			@PathVariable("bdate") String bdate	) {
    			return pdao.getBookingByDate(bdate);
    }
